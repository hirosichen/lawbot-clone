...
### 2026-04-07 (搜尋頁改版)
- 搜尋頁改版：新增常用法律 chips 與客製化 modal、日期範圍年份 slider popover、文件類型多選 popover、搜尋技巧 popover、搜尋歷史 modal、排序切換；保留收藏與高亮功能

### 2026-04-07 (案件詳情頁分頁化)
- 案件詳情頁改為 7 分頁結構（概覽/附件/實體/爭點/缺口分析/書狀/法律研究），新增實體、爭點、缺口、參考資料、書狀等子資料管理，附件 tab 整合現有 /api/upload
- 概覽頁加入 4 張統計卡片（附件/實體/爭點/缺口）與案件摘要 placeholder，並保留標題/事實/筆記的自動儲存與刪除流程
